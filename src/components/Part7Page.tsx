    ...
    return (
        <div className="scroll-container-left" style={{
            ...
            <div style={{ marginBottom: '25px', textAlign: 'center', zIndex: 2 }}>
                <span style={{ fontFamily: "'Cinzel', serif", fontSize: '0.7rem', letterSpacing: '2px', color: '#8B2323', fontWeight: 'bold' }}>
                    HỆ THỐNG QUAN ĐIỂM
                </span>
            ...
            {/* Page Number */}
            <div style={{ position: 'absolute', bottom: '15px', left: '20px', fontFamily: "'Cinzel', serif", fontSize: '0.8rem', color: '#8B2323', fontWeight: 'bold' }}>20</div>
        </div>
    );
}
    ...
    return (
        <div className="scroll-container-right" style={{
            ...
            <div style={{
                ...
                <span style={{ fontFamily: "'Cinzel', serif", fontSize: '0.75rem', color: '#C9A227', letterSpacing: '2px', textTransform: 'uppercase' }}>
                    Tư tưởng nhân văn
                </span>
            ...
            <div style={{
                ...
                <h3 style={{ fontFamily: "'Cinzel', serif", fontSize: '0.9rem', color: '#8B2323', marginBottom: '10px', fontWeight: 'bold' }}>
                    SỨC MẠNH CỦA DÂN
                </h3>
            ...
            <div style={{ marginTop: 'auto', textAlign: 'center', opacity: 0.6 }}>
                ...
                <p style={{ fontFamily: "'Cinzel', serif", fontSize: '0.65rem', letterSpacing: '1px', color: '#8B2323' }}>
                    LÝ LUẬN CÁCH MẠNG VIỆT NAM
                </p>
            </div>

            {/* Page Number */}
            <div style={{ position: 'absolute', bottom: '15px', right: '20px', fontFamily: "'Cinzel', serif", fontSize: '0.8rem', color: '#8B2323', fontWeight: 'bold' }}>21</div>
        </div>
    );
}