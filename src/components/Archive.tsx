...
export function Archive({ onClose }: { onClose: () => void }) {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 10000, background: '#FDFBF7', overflowY: 'auto' }}>
            <style>{`
                @import url('https://fonts.googleapis.com/css2?family=Cinzel:wght@400;700;900&family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400&family=Lora:ital,wght@0,400;0,500;1,400&family=Manrope:wght@300;400;600;700&display=swap');
            ...
            <header style={{ position: 'sticky', top: 0, background: 'rgba(244, 241, 234, 0.98)', backdropFilter: 'blur(10px)', borderBottom: '1px solid #C9A227', zIndex: 100, padding: '16px 24px' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                            <h1 style={{ fontFamily: "'Cinzel', serif", fontSize: '1.4rem', color: '#1A1A1A', margin: 0, fontWeight: 900 }}>Tàng Kinh Các</h1>
                            ...
                            <div className="book-cover" style={{ width: 120, height: 180, background: doc.coverColor, borderRadius: '2px 4px 4px 2px', flexShrink: 0, overflow: 'hidden' }}>
                                ...
                                {doc.coverImage ? (
                                    ...
                                    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: 12, textAlign: 'center', border: '1px solid rgba(255,255,255,0.2)' }}>
                                        <span style={{ fontSize: '0.45rem', color: 'rgba(255,255,255,0.7)', letterSpacing: '0.15em', marginBottom: 8, fontFamily: "'Cinzel', serif" }}>HỒ CHÍ MINH</span>
                    ...
                    <div onClick={(e) => e.stopPropagation()} style={{ background: '#FAF6F0', width: '100%', maxWidth: 1150, height: '92vh', borderRadius: 4, overflow: 'hidden', display: 'flex', boxShadow: '0 50px 100px rgba(0,0,0,0.5)', position: 'relative', border: '1px solid #C9A227' }}>
                        ...
                        <div style={{ width: 380, background: '#1A1A1A', padding: '60px 40px', color: 'white', display: 'flex', flexDirection: 'column', flexShrink: 0, borderRight: '1px solid rgba(201, 162, 39, 0.3)' }}>
                            ...
                            <div style={{ display: 'flex', gap: 10, marginBottom: 30, justifyContent: 'center' }}>
                                <span style={{ border: '1px solid #C9A227', color: '#C9A227', padding: '4px 16px', borderRadius: 2, fontSize: '0.7rem', fontWeight: 800, fontFamily: "'Cinzel', serif" }}>{selectedDoc.year}</span>
                            ...
                            <a href={selectedDoc.officialLink} target="_blank" rel="noopener noreferrer" style={{ marginTop: 'auto', padding: '18px', background: '#8B2323', color: 'white', borderRadius: 2, fontWeight: 800, textDecoration: 'none', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, transition: '0.3s', fontFamily: "'Cinzel', serif", letterSpacing: '1px', fontSize: '0.85rem', boxShadow: '0 10px 20px rgba(139, 35, 35, 0.3)' }} onMouseEnter={(e) => e.currentTarget.style.background = '#A52A2A'} onMouseLeave={(e) => e.currentTarget.style.background = '#8B2323'}>
                        ...
                        <div className="custom-scrollbar reading-content" style={{ flex: 1, padding: '80px 100px', overflowY: 'auto', background: '#FFFFFF', position: 'relative' }}>
                            ...
                            <div style={{ maxWidth: 680, margin: '0 auto', position: 'relative', zIndex: 1 }}>
                                ...
                                <div style={{ textAlign: 'center', marginBottom: 70 }}>
                                    <span style={{ fontFamily: "'Cinzel', serif", fontSize: '0.85rem', color: '#C9A227', letterSpacing: '0.4em', textTransform: 'uppercase', display: 'block', marginBottom: 15, fontWeight: 700 }}>Trích đoạn tiêu biểu</span>
