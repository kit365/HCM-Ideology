    ...
    return (
        <div className="scroll-container-left" style={{
            ...
            <div style={{
                ...
                <span style={{ fontFamily: "'Cinzel', serif", fontSize: '0.75rem', letterSpacing: '3px', color: '#8B2323', fontWeight: 'bold', display: 'block', marginBottom: '0.5rem' }}>
                    HỆ THỐNG QUAN ĐIỂM
                </span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem', zIndex: 2, opacity: isRevealed ? 1 : 0, transition: 'all 0.6s ease 0.4s' }}>
                <div style={{ borderBottom: '1px solid rgba(139, 35, 35, 0.1)', paddingBottom: '1rem' }}>
                    <h4 style={{ fontFamily: "'Cinzel', serif", color: '#8B2323', fontSize: '0.9rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>01. CHÍNH QUỐC</h4>
                ...
                <div style={{ borderBottom: '1px solid rgba(139, 35, 35, 0.1)', paddingBottom: '1rem' }}>
                    <h4 style={{ fontFamily: "'Cinzel', serif", color: '#8B2323', fontSize: '0.9rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>02. THUỘC ĐỊA</h4>
                    <p style={{ fontFamily: "'Lora', serif", fontSize: '0.85rem', lineHeight: 1.6, margin: 0 }}>
            ...
            {/* Page number */}
            <div style={{ position: 'absolute', bottom: '15px', left: '20px', fontFamily: "'Cinzel', serif", fontSize: '0.8rem', color: '#8B2323', fontWeight: 'bold' }}>22</div>
        </div>
    );
}
    ...
    return (
        <div className="scroll-container-right" style={{
            ...
            <div style={{
                ...
                <div style={{ fontFamily: "'Cinzel', serif", fontSize: '0.7rem', color: '#C9A227', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '0.3rem', fontWeight: '800' }}>
                    Đối Chiếu Quan Điểm
                </div>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '1rem' }}>
                    <div style={{ backgroundColor: '#8B2323', color: '#fff', padding: '0.6rem 1rem', fontFamily: "'Cinzel', serif", fontSize: '0.8rem', fontWeight: 'bold', borderRadius: '2px' }}>CHÍNH QUỐC</div>
                    <div style={{ color: '#C9A227', fontSize: '1.5rem', fontWeight: 'bold' }}>⇆</div>
                    <div style={{ backgroundColor: '#8B2323', color: '#fff', padding: '0.6rem 1rem', fontFamily: "'Cinzel', serif", fontSize: '0.8rem', fontWeight: 'bold', borderRadius: '2px' }}>THUỘC ĐỊA</div>
                </div>
            ...
            <div style={{
                ...
                <p style={{ fontFamily: "'Cinzel', serif", fontSize: '0.75rem', color: '#8B2323', fontWeight: 'bold', letterSpacing: '1px', margin: 0 }}>
                    SÁNG TẠO LỚN NHẤT CỦA HỒ CHÍ MINH TRONG LÝ LUẬN MÁC-LÊNIN
                </p>
            </div>

            {/* Page number */}
            <div style={{ position: 'absolute', bottom: '15px', right: '20px', fontFamily: "'Cinzel', serif", fontSize: '0.8rem', color: '#8B2323', fontWeight: 'bold' }}>23</div>
        </div>
    );
}